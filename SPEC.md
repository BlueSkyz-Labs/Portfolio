...
**Quiet luxury** is the discipline of removing everything that is not essential — until what remains cannot be ignored. It is the opposite of attention-grabbing: it is *attention-earning*. A user who lands on this site should feel they have arrived somewhere curated, not somewhere that was launched.
...
**Rules of use:**
- The gold accent is a *single* hairline (`1px` solid `var(--gold-champagne)`), not a fill. Champagne is the thread of a stitch, not a button color.
- Never use pure black (`#000000`) or pure white (`#FFFFFF`). The warmth of the off-palette is what makes the design feel *physical*.
...
Motion is the *fingerprint* of an interface. We use motion to:
...
The mix of sharp and soft is what makes the design feel *intentional* rather than template-y.
...
No carousel. No video background. No 3D. The hero is *the typography*.
...
> *Restraint, materiality, and precision — applied with the discipline of a master tailor, delivered at the speed of the edge.*
